                                ...
                                <div class="pull-right tableTools-container">
                                    <div class="dt-buttons btn-overlap btn-group">
                                        <a flag="info"
                                           ...
                                           data-toggle="tooltip"
                                           title='Thêm sản phẩm' href="<c:url value="/admin-product?action=chinhsua"/>">
															<span>
                                    ...
                                    <table class="table table-bordered">
                                        ...
                                        <c:forEach var="item" items="${model.listResult}">
                                            <tr>
                                                ...
                                                <td>${item.categoryModel.nameCategory}</td>
                                                <td>${item.producerModel.nameProducer}</td>
                                                ...
                                                <td>
                                                    <a class="btn btn-sm btn-primary btn-edit" data-toggle="tooltip"
                                                       title="Cập nhật" href='<c:url value="admin-product?action=chinhsua&id=${item.id}"/>'><i
